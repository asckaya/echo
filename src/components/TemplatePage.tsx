...
interface TemplatePageProps {
  pageKey: 'about' | 'articles' | 'docs' | 'experience' | 'guide' | 'home' | 'projects' | 'publications'
}
...
export function TemplatePage({ pageKey }: TemplatePageProps) {
  ...
  const Page = template.pages[pageKey === 'about' ? 'aboutPage' : pageKey as keyof typeof template.pages]
